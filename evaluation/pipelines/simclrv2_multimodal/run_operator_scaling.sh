...
readonly OUTPUT_ROOT="${OUTPUT_ROOT:-/workspace/OptimalCedar/outputs/motivation_multimodal/simclrv2_multimodal_operator_scaling_20260909}"
...
python -m evaluation.pipelines.simclrv2_multimodal.operator_scaling \
    --fixture "${FIXTURE}" \
