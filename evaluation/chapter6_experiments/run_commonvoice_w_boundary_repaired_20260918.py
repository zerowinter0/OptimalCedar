...
def main():
    ...
    root = REPO / "outputs/commonvoice_15000_w_boundary_repaired_ray_20260918"
    ...
    profile_source = REPO / "outputs/remote_ray_boundary_fix_validation_20260918/shared_repaired.yaml"
    metadata.update(methods={m: m for m in methods}, repeats=1,
        profile_policy="reuse_exact_repaired_remote_boundary_profile_without_reprofiling",
