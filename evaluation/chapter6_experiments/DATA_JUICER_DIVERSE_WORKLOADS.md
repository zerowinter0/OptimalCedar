...
screening runs finish. In addition, the original Cedar plans behind reused
Pile results are being re-audited with the current 3,600-second plan threshold;
their historical 300-second unavailability records alone are not treated as
sufficient under the current protocol.
